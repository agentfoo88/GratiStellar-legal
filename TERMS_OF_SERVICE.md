...
By downloading, installing, or using GratiStellar ("the App," "Service," "we," "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

**You must be at least 13 years old to use GratiStellar.** If you are under 18, you must have parental or guardian consent.

---

## 2. Description of Service

GratiStellar is a personal gratitude journaling application that allows you to:
- Create and store gratitude entries
- Organize entries into collections (galaxies)
- Sync data across your devices via cloud services
...
- You may create an anonymous account (display name only)
- You may link your account to an email address for enhanced security
...
- We are not liable for losses due to stolen or compromised credentials
- You must use a secure password if using email authentication
...
- You retain all rights to the content you create (gratitude entries, names, preferences)
...
- You must not post illegal, harmful, threatening, abusive, or offensive content
- You must not impersonate others or misrepresent your affiliation
- You must not attempt to harm or exploit the Service

### 4.3 Content Backup

- **You are responsible for backing up your own data**
- We provide backup/export features, but we recommend you maintain personal backups
- We are not liable for data loss due to any reason

### 4.4 Prohibited Content

You must not use the Service to create, store, or transmit:
- Illegal content
- Content that infringes intellectual property rights
- Malware, viruses, or malicious code
- Spam or unsolicited communications (if sharing features are added)
...
- Organizing and reflecting on your entries
- Exporting your personal data
- Using features as intended
...
- Abuse, harass, or harm other users (if community features are added)
...
- GratiStellar, including its code, design, logo, and branding, is protected by copyright and trademark laws
...
- The App may include third-party libraries and open-source software
- These are governed by their respective licenses
- Attributions are available in the app's settings
...
- We may release updates to improve the App
- Some updates may be mandatory for security or functionality
- We may change features, remove features, or add new ones
...
- If we decide to discontinue the Service, we will:
  ...
  - Honor any paid subscriptions (if applicable in the future)
...
### 9.2 No Medical or Therapeutic Claims

- GratiStellar is a journaling tool, NOT a medical or therapeutic service
- It is not a substitute for professional mental health treatment
- We make no claims about health benefits
...
- We are NOT liable for data loss, even if we were advised of the possibility
- Our total liability to you shall not exceed $100 USD or the amount you paid us (if any)
...
You agree to indemnify, defend, and hold harmless GratiStellar, its developers, and affiliates from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
...
- Firebase's terms and privacy policies apply
- We are not responsible for Firebase service issues
...
- GratiStellar is currently **FREE** to use
- All features are available at no cost

### 12.2 Future Pricing

- We may introduce paid features, subscriptions, or premium tiers in the future
- Existing free features will remain free
- You will be notified before any charges are introduced
...
- We will notify you via in-app notification or email (if provided)
- Changes are effective 30 days after notification
...
These Terms, along with the Privacy Policy, constitute the entire agreement between you and GratiStellar.
...
By using GratiStellar, you acknowledge that:
...
**Thank you for using GratiStellar. We hope our app helps you cultivate gratitude in your daily life.**
